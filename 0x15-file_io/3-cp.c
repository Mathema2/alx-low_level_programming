...
/**
 * error_handler - return respective exit status
 * @fd: file descriptor
 * @fname: file descriptor of the file name
 * @type: type of system call
 * @buffer: buffer to be free if exit status
 * Return: 0 on success and exit status on error
 */
 ...
 * @fileName: file dest that print errors
 ...
 * @argc: number of string parameters
